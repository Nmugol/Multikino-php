...
<?php if (isset($_SESSION['user'])) : ?>
    <?php if ($_SESSION['user'] == 'admin') : ?>
        ...
        <li class="nav-item"><a class="nav-link" style="color:white; text-shadow: black 0.1em 0.1em 0.2em;" href="rezerwacje_admin.php">Wyświetl rezerwacje <i class="fa fa-calendar-check"></i></a></li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" style="color:white; text-shadow: black 0.1em 0.1em 0.2em;" data-bs-toggle="dropdown"> Zarządzaj filmami </a>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="film.php"><i class="fa fa-film"></i> Dodaj film </a></li>
                <li><a class="dropdown-item" href="film_tabela.php"><i class="fa fa-table"></i> Tabela filmów </a></li>
            </ul>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" style="color:white; text-shadow: black 0.1em 0.1em 0.2em;" data-bs-toggle="dropdown"> Zarządzaj seansami </a>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="dodaj_seans.php"><i class="fa fa-clock"></i> Dodaj seans </a></li>
                <li><a class="dropdown-item" href="seans_tabela.php"><i class="fa fa-table"></i> Tabela seansów </a></li>
            </ul>
        </li>
    <?php else : ?>
